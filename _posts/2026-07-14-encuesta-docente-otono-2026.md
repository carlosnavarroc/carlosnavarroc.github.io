...
<div style="text-align: justify;">
En la Universidad del Desarrollo el sistema institucional presenta los resultados únicamente mediante indicadores agregados, por lo que no es posible reproducir capturas de pantalla de la plataforma. Sin embargo, los resultados generales fueron igualmente muy satisfactorios, alcanzando un promedio global de <strong>92,9%</strong>.
</div>
