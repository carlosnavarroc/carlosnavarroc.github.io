...
- **Overview:** Teaching is one of my main professional interests. Coming from a family of educators, I deeply value both the challenges and rewards of engaging students in the learning process.  
...
- **2026**: *"Development and implementation of a computer vision system based on Transformers, for vehicle identification and fraud prevention on highways"*  
  **Author:** Diego Vega  (DIE). [Read Thesis](https://www.cec.uchile.cl/~canavarr/Tesis/cf-vega_da_compressed.pdf)
- **2024**: *"Automated diagnosis of glaucoma using Machine Learning tools applied to Chromatic Pupilometry data."*  
  **Author:** Manuel Zamorano (DIE). [Read Thesis](https://www.cec.uchile.cl/~canavarr/Tesis/cf-zamorano_mc_compressed.pdf)
...
- **2023**: *"Intelligent image recognition engine for last-mile delivery quality control."*  
  **Author:** Franco Mirauda (DIE).  [Read Thesis](https://www.cec.uchile.cl/~canavarr/Tesis/cf-mirauda_fl_compressed.pdf)
